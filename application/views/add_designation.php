 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="lnr lnr-plus-circle"></i>  ADD Designation</h1>
      <ol class="breadcrumb">
    ...
    <?php if($this->session->success): ?>
     ...
     <?php endif; ?>
             ...
             <?php  echo form_open('designation/save_designation',array('id'=>'')) ?>
                 ...
                 <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input name="desig_name" class="form-control" type="text" placeholder="Designation Name" required="">
                    </div>
                ...
                <div class="col-md-offset-4 col-md-6 submit-button">
                    <input type="submit" value="Save Departmnet" name="addepartment" class="btn btn-success">
