						...
						<div class="module-head">
							...
							<div class="module-option clearfix">
								...
								<div class="pull-right">
									...
									<a href="<?php echo base_url(); ?>add_course" class="btn btn-primary"><i class="menu-icon icon-plus"></i>  Add New</a>
								</div>
							</div>
						</div>
						<div class="module-body table">
							<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
								...
								<tbody>
									...
									<td nowrap><?php echo $course->course_status;?></td>
									
									<td nowrap>
									   <a href="<?php echo base_url();?>edit_course/<?php echo $course->course_id; ?>" class="btn btn-success"><i class="menu-icon icon-edit"></i>
								       </a>
									   <a href="<?php echo base_url();?>delete_course/<?php echo $course->course_id; ?>" class="btn btn-danger"><i class="menu-icon icon-trash" onclick="return confirm('are you sure to delete?')"></i>
									   </a>
