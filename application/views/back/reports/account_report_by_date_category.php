		...
		<div class="wraper">
			<table width="100%">
				<tr>
					...
					<td width="13%" align="right" valign="top" nowrap="nowrap"><h2>ACCOUNT REPORT BY CATEGORY </h2>
						<strong>Category: <?php echo $applications[0]->acc_cat_title ;?> <strong><BR>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" width="100%">
					...
					<tbody>
							...
							<tr class="odd gradeX">
								...
								<td nowrap align="center"><?php echo format_date($application->account_date);?></td>
								<td nowrap><?php echo $application->account_description ;?></td>
								<td align="center" nowrap><?php echo $application->account_cash_in ;?></td>
								<td align="center" nowrap><?php echo $application->account_cash_out ;?></td>
							</tr>
                             <?php $i++; } ?>
