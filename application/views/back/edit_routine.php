									...
									<div class="span10">
										<div class="content">
											<div class="module">
												...
												<?php  echo form_open_multipart('routine/update_routine/'.$all_edit_routine[0]->routine_id,array('id'=>'')) ?>
														<div class="row-fluid">
															<div class="span5">
																...
																<option value="" disabled="" selected="">Select batch</option>
																 <?php  foreach($batchs as $batch): ?>
																		<option value="<?php echo $batch->batch_id; ?>" <?php if($batch->batch_id == $all_edit_routine[0]->batch_id): ?> selected="" <?php endif; ?>><?php echo $batch->batch_title; ?></option>
																	 <?php endforeach; ?>	
																	</select>
																</div>
															</div>
														...
														<div class="row-fluid">
															<div class="control-group">
																...
																<div class="controls">
																	<textarea class="span12" name="routine_details" id="editor" rows="5"> <?php echo $all_edit_routine[0]->routine_details;?></textarea>
																</div>
															</div>
														</div>
														<center>
