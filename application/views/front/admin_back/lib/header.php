...
<html lang="en">
	...
	<li><a href="../admin" > <i class="menu-icon icon-user"></i>  Admin</a></li>
	
	
	<li class="dropdown">
		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="menu-icon icon-globe"></i> Web<b class="caret"></b></a>
		<ul class="dropdown-menu">
			<li><a href="../web" target="_blank"> <i class="menu-icon icon-globe"></i>  Web View</a></li>
			<li><a href="index.php" > <i class="menu-icon icon-globe"></i>  Page Archive</a></li>
			<li><a href="site.php" > <i class="menu-icon icon-globe"></i>  Website Profile</a></li>
		</ul>
	</li>
	
	<li class="nav-user dropdown">
		<a href="#" class="dropdown-toggle" data-toggle="dropdown">
			<img src="<?php echo base_url();?>asset/front/images/user.png" class="nav-avatar" />
			<b class="caret"></b>
		</a>
		<ul class="dropdown-menu">
