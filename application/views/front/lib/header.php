					...
					<div class="clearfix">
						...
						<div class="top-right">
							<ul class="info-links clearfix">
								...
								<li><a href="#"><span class="icon fa fa-sign-in"></span> Student Portal</a></li>
								 </ul>
						</div>
					</div>
				</div>
			...
			<div class="top-header">
				<div class="container">
					<div class="logo-wrapper">
						<div class="logo"><a href="index.php"><img src="<?php echo base_url();?>asset/front/images/logo.png" alt="amplebiz" title="AmpleBiz"></a></div>
					</div>
					<!-- Main Menu -->
					<nav class="main-menu">
						...
						<div class="navbar-collapse collapse clearfix">
							<ul class="navigation clearfix">
								<li class="current"><a href="<?php echo base_url();?>front/index">Home</a></li>
								<li><a href="<?php echo base_url();?>front/about">About Us</a></li>
								<li><a href="<?php echo base_url();?>front/course">Course</a></li>
								<li><a href="<?php echo base_url();?>front/news">News</a></li>
